...
const Icon:FC<IconProps> = (props) =>{
    ...
    if(!type||(type && type.trim().length===0)){
        return <span>[Icon&#39;s type is empty]</span>
    }
    ...
    switch (type){
        ...
        case 'github':
            return <svg aria-label="github" height="19" viewBox="0 0 14 14" width="19">
        ...
        case 'mail':
            return <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 20" stroke="currentColor" strokeWidth={2}>
